...
def compile_ttir_to_ptx_inplace(
  ...
  cluster_dims = (1,1,1)
  #print(f"RB name={name}") 
  #print(f"RB hsaco={hsaco}") 
  #print(f"RB hsaco[0]={hsaco[0]}") 
  #print(f"RB hsaco[1]={hsaco[1]}")
  fd, hsaco_path = tempfile.mkstemp() 
  with os.fdopen(fd, "wb") as f:
    f.write(hsaco)
  #print(f"RB: hsaco_path={hsaco_path}")  
  #with open(hsaco_path,"rb") as f:
  #  data = f.read()
  #  print(f"RB hsaco read back={data}")
  #hsaco = hsaco[0].decode('unicode_escape')
  #print(f"RB hsaco={hsaco}")
  #print(f"RB type(hsaco)={type(hsaco)}")
  return hsaco_path, name, shared_mem_bytes, compute_capability, cluster_dims
...
def get_or_create_triton_kernel(
  ...
  if kernel is None:
    ...
    print(f"RB: arch={arch}, target={tc.driver.active.get_current_target()}")
    ...
    hsaco, kernel_name, shared_mem_bytes, compute_capability, cluster_dims = (
